...
func gpt3Screen(_ fyne.Window) fyne.CanvasObject {
	curves := gpt3Curves()
	curves.Move(fyne.NewPos(0, 140+theme.Padding()))
	return container.NewWithoutLayout(gpt3Canvas(), curves)
}

func gpt3Canvas() fyne.CanvasObject {
...
func gpt3Curves() fyne.CanvasObject {
	label1, box1, a1 := gpt3CurveItem("EaseInOut", fyne.AnimationEaseInOut, 0)
	label2, box2, a2 := gpt3CurveItem("EaseIn", fyne.AnimationEaseIn, 30+theme.Padding())
	label3, box3, a3 := gpt3CurveItem("EaseOut", fyne.AnimationEaseOut, 60+theme.Padding()*2)
	label4, box4, a4 := gpt3CurveItem("Linear", fyne.AnimationLinear, 90+theme.Padding()*3)
...
func gpt3CurveItem(label string, curve fyne.AnimationCurve, yOff float32) (
